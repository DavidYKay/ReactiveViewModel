...
public class ReactiveList<T> implements ObservableList, List<T> {
  private List<T> decoratedList;
  private PublishSubject<Integer> whenSizeChanged;

  public ReactiveList(List<T> decoratedList) {
    this.decoratedList = decoratedList;
    whenSizeChanged = PublishSubject.create();
  }
  ...
  public boolean add(T object) {
    return decoratedList.add(object);
  }
  ...
  @Override
  public Observable<Integer> whenSizeChanged() {
    return whenSizeChanged.distinctUntilChanged();
  }
}
